const config = {
  api: {
    baseURL: import.meta.env.VITE_REACT_APP_API_BASE_URL || 'http://localhost:80/api',
    socketUrl: import.meta.env.VITE_REACT_APP_SOCKET_URL || 'http://localhost:80/api/comment/ws',
