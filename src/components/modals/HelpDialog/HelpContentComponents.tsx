      ...
      },
      {
        ...
        content: (
          <Space direction='vertical'>
            <Paragraph strong>Как создать команду?</Paragraph>
            <Paragraph>
              Для создания команды перейдите в раздел "Команды" и нажмите кнопку "Создать команду".
            </Paragraph>
            <Paragraph strong>Что такое подсказки?</Paragraph>
            <Paragraph>
              Подсказки - это всплывающие при наведении на элементы интерфейса подсказки, которые
              помогают понять их функционал.{' '}
            </Paragraph>
          </Space>
        ),
      },
