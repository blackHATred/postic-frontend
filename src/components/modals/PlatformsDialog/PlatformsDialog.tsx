        ...
        return (
          <div className={styles['platform-instructions']}>
            ...
            <ol>
              ...
              <li>Выберите раздел Работа с API {'>'} Ключи доступа</li>
              <li>Создайте ключ доступа с необходимыми правами</li>
              <li>Скопируйте ID группы и ключ группы.</li>
              <li>
                Для корректной работы с сообществом перейдите в раздел Работа с API {'>'} LongPoll
                API и разрешите Long Poll API
              </li>
              <li>
